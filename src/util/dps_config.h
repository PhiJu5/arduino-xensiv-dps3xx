...
#define DPS__OVERSAMPLING_RATE_1 DPS__MEASUREMENT_RATE_1  // 0
#define DPS__OVERSAMPLING_RATE_2 DPS__MEASUREMENT_RATE_2  // 1
#define DPS__OVERSAMPLING_RATE_4 DPS__MEASUREMENT_RATE_4  // 2
#define DPS__OVERSAMPLING_RATE_8 DPS__MEASUREMENT_RATE_8  // 3
#define DPS__OVERSAMPLING_RATE_16 DPS__MEASUREMENT_RATE_16  // 4
#define DPS__OVERSAMPLING_RATE_32 DPS__MEASUREMENT_RATE_32  // 5
#define DPS__OVERSAMPLING_RATE_64 DPS__MEASUREMENT_RATE_64  // 6
#define DPS__OVERSAMPLING_RATE_128 DPS__MEASUREMENT_RATE_128 // 7
